# :cloud_with_lightning: lighty YANG Validator 14.3.0
...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-14.3.0-bin.zip*
...
```
unzip lighty-yang-validator-14.3.0-bin.zip
```
