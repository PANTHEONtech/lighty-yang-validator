# :cloud_with_lightning: lighty YANG Validator 17.0.2
...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-17.0.2-SNAPSHOT-bin.zip*
...
```
unzip lighty-yang-validator-17.0.2-SNAPSHOT-bin.zip
```
