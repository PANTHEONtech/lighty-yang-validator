...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-17.0.1-bin.zip*
...
```
unzip lighty-yang-validator-17.0.1-bin.zip
```
