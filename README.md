...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-21.4.0-SNAPSHOT-bin.zip*
...
```
unzip lighty-yang-validator-21.4.0-SNAPSHOT-bin.zip
```
