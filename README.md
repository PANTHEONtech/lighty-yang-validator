# :cloud_with_lightning: lighty YANG Validator 16.1.0
...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-16.1.0-SNAPSHOT-bin.zip*
...
```
unzip lighty-yang-validator-16.1.0-SNAPSHOT-bin.zip
```
