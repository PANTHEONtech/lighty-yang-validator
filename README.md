...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-20.2.0-bin.zip*
...
```
unzip lighty-yang-validator-20.2.0-bin.zip
```
