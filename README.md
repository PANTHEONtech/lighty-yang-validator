# :cloud_with_lightning: lighty YANG Validator 13.1.1-SNAPSHOT
...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-13.1.1-SNAPSHOT-bin.zip*
